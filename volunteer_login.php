...
if(isset($_POST['submit'])){
   ...
   $select = $conn->prepare("SELECT * FROM `volunteers` WHERE email = ? AND password = ?");
...
<section class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>don't have an account? <a href="volunteer_registration.php">register now</a></p>
...
<section class="text_link">
   <div class="volunteer_login">
      <h1><a href="#">Senior Citizen Login -></a></h1>
   </div>
</section>
