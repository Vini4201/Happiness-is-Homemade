...
if(isset($_POST['submit'])){
   ...
   $select = $conn->prepare("SELECT * FROM `volunteers` WHERE email = ?");
   ...
   if($select->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $insert = $conn->prepare("INSERT INTO `volunteers`(name, email, password, image) VALUES(?,?,?,?)");
...
<section class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>already have an account? <a href="volunteer_login.php">login now</a></p>
      <input type="submit" value="register now" class="btn" name="submit">
   </form>

</section>

<section class="text_link">
   <div class="volunteer_login">
      <h1><a href="register.php">Senior Citizen Registration -></a></h1>
   </div>
</section>
