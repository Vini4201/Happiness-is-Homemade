        ...
        <nav class="navbar navbar-expand-md navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto py-4 py-md-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/Website For Elderly People/senior_home.html">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/Website For Elderly People/senior_activities.php">Activities</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Classes</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/Website For Elderly People/senior_suggestions.html">Suggestions</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/Website For Elderly People/senior_volunteerprofile.html">Volunteer Profiles</a>
                    </li>
                </ul>
            </div>
                ...
                //Information
                    echo "<div class='postcard__text t-dark'>";
                        ...
                        echo "<ul class='postcard__tagbox'>";
                            ...
                            echo '<a href="senior_classes.php?del=' . $row['id'] . '"><i class="fas fa-xmark mr-2"></i>Delete</a>';
                            echo "</li>";
                        echo "</ul>";
                    echo "</div>";
...
<form method="POST" action="senior_classes.php" enctype="multipart/form-data">
    ...
    <!--filter-->  <!-- <div class="filterDiv cars"> -->
                    <article class="postcard light green">
                        ...
                        <div class="postcard__text t-dark">
                            <h1 class="postcard__title green"><input 
                                class="name" 
                                name="image_heading" 
                            ...
                            <div class="postcard__subtitle small">
                                <time datetime="2020-05-25 12:00:00">
                                    <i class="fas fa-calendar-alt mr-2"></i><input type="date" class="activity_date" name="class_date">
                                </time>
                            </div>
                            ...
                            <ul class="postcard__tagbox">
                                ...
                                <li class="tag__item"><i class="fas fa-clock mr-2"></i><input 
                                    class="name" 
                                    name="senior_name" 
                                    placeholder="Enter your name"></textarea></li>
                                <!--Google Form-->
                            ...
                            <div>
                                <button class="submit" type="submit" name="upload">Add Class</button>
                              </div>
                        </div>
                    </article>
               <!-- </div> -->
